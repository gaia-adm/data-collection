...
public class OnCloudPlannedCollectionProvider implements PlannedCollectionProvider {
...
/*    // for tests
    ...
    // for tests
    void setOnPremProvidersConfigService(final OnCloudProvidersConfigService onPremProvidersConfigService) {
        this.onCloudProvidersConfigService = onPremProvidersConfigService;
    }*/

    @Override
    public PlannedCollection findNextPlannedCollection() {
        List<ProviderConfig> configList = onCloudProvidersConfigService.getProviderConfigs();
        PlannedCollection plannedCollection = null;
        long currentTimestamp = System.currentTimeMillis();
        //TODO - boris: handle state
